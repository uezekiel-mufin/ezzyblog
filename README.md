...
# Tech Talks <a name="about-project"></a>
...
<ul>
  ...
  <li><a href="https://tailwind.com">TailwindCSS</a></li>
...
- [Clike Here!!!](https://https://ezzyblog.vercel.app/)
...
```sh
  cd my-folder
  git clone https://github.com/Ezzywealth/ezzyblog
```
...
- Follow the steps below
  ...
  - Visit this link "https://github.com/Ezzywealth/ezzyblog"
...
We would like to thank God Almighty for giving us the strength to complete this project
