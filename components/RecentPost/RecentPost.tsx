...
const RecentPost = ({ post }: Props) => {
	return (
		<div key={post._id}>
			<div className='grid grid-cols-2 shadow-lg p-3 gap-3 w-full border border-skin-bgBorder border-solid drop-shadow-xl hover:scale-105 transition-transform duration-200'>
